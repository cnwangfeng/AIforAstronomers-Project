...
> 文件状态：本文件为 background/review notes；具体执行以 `PartI_II_editorial_spec_V2.md` 为准。文中 command log / version record / photometry record 等独立模板表述，在 V2 中均收束为 Evidence Record 的 chapter-specific fields。
