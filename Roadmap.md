...
- 继续抽查章节交叉引用、公式解释边界和八张 capstone evidence cards 的入口、过渡和收束是否统一。
...
- 在完整项目仓库运行 `python scripts/smoke_test_notebooks.py`、`python scripts/validate_data_manifest.py`、`bash scripts/build_book_local.sh zh` 和 `git diff --check`。
