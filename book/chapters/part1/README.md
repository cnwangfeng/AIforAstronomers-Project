...
- The current reader-QA pass adds minimum record templates for command-line runs, script runs, data checks, version-linked results, and figure explanations, so Part I outputs can feed the 项目证据卡.
