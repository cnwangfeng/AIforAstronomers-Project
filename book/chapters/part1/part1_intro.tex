...
章节 & 本章交付件 & 保护的科研环节 \\
\midrule
Linux & Evidence Record、目录快照、日志 & 位置、输入、运行过程 \\
Git & Evidence Record、tag/release 说明 & 历史、代码状态、结果冻结 \\
脚本/Jupyter & Evidence Record、函数/module 边界 & 可重跑入口、环境、参数 \\
数据 I/O & Evidence Record、字段/header 契约 & 数据含义、单位、质量控制 \\
绘图 & Evidence Record、图表生成脚本、解释边界 & 证据呈现、科学论断、限制 \\
\bottomrule
\end{tabular}
\end{center}
