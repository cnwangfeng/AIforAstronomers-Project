...
- The latest polish pass adds minimum result-report templates for the HR diagram, aperture photometry, and spectroscopy chapters, so students can connect computed values to evidence, assumptions, and limitations.
