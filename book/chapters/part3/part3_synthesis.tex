...
\section*{Model Experiment Packet 怎样进入后续项目}

Part III 的 Model Experiment Packet 到了后续案例、课程项目或独立研究练习中，会拆入不同证据区：
...
因此，从这一部分开始，推荐把每一次实验都当作未来项目包的一段证据来保存。不要等到期末才回忆模型怎么训练、数据怎么划分、为什么选择这个指标；那时很多关键判断已经很难复原。
