...
把视角放到 后续项目里，这个逻辑会更加重要。你未来真正会遇到的任务，往往不是“从零手写每一行代码”，而是：
...
因此，到了 后续项目，本章的交付物不应该只是“AI 帮我改了代码”这句话，而应包括被拒绝的草稿、通过的 regression checks、关键数值快照和人工确认说明。这些内容会进入 Evidence Record、AI Usage Log 和 disclosure note，帮助读者判断 AI 参与之后结果是否仍然可复查。
