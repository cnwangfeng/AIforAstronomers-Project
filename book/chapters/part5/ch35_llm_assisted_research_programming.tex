...
因此，到了 Part VI，本章的交付物不应该只是“AI 帮我改了代码”这句话，而应包括被拒绝的草稿、通过的 regression checks、关键数值快照和人工确认说明。这些内容会进入 Evidence Record、AI Usage Log 和 disclosure note，帮助读者判断 AI 参与之后结果是否仍然可复查。
