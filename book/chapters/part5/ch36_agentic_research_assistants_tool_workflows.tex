...
在最终 capstone 包里，action log 会成为 Evidence Record 和 AI Usage Log 的一部分，manual review queue 会作为 error / review artifact 进入项目包。它们共同回答一个问题：代理每一步为什么这样做，以及它在哪些边界处停下来交还给人。
