...
到了 后续项目里，这条逻辑会非常实用。真实项目中，你很可能会让 AI 帮你：
...
进入后续项目后，claim ledger 会支撑 Evidence Record、AI Usage Log 和最终报告的 claim boundary：它说明哪些结论有证据、哪些只是 caveat，也说明引用、页码和人工复核是否已经完成。这样，AI 辅助写作就不会把证据链压扁成一段流畅但不可回查的文字。
