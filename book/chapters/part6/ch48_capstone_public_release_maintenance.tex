...
\section{案例导读：公开发布意味着别人会真的尝试使用}

把课程包放到公开仓库并不等于发布完成。真正的公开发布要让陌生读者知道从哪里开始、哪些材料是稳定入口、哪些内容只是示例、遇到问题时边界在哪里。

本章把 public release 看成一份面向外部读者的可用性承诺。它要求课程团队同时检查索引、许可证、数据边界、运行入口和维护节奏，避免“东西都在，但没人知道该怎么用”的状态。
