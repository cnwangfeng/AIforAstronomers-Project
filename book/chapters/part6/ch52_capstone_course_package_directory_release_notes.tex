...
在本章教学数据上，只按下一版优先级取前四项，真正目录可发布的精度只有 0.25，未就绪条目混入率是 0.75。结构化 directory workflow 会先看 release-note 状态，再看 version pointer，再看 audience copy，最后补 directory entry：
