...
在本章教学数据上，只按 readiness score 取前四项，真正替班可接手的精度只有 0.25，未就绪场景混入率是 0.75。结构化 substitute workflow 会先看 escalation，再看 owner，再检查 minimal run package，最后确认 context brief：
