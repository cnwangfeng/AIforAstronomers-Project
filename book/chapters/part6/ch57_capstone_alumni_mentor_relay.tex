...
\section{案例导读：导师接力需要边界，不只是热情}

校友和外部导师可以给 Capstone 带来真实经验、案例材料和职业视角，但如果责任边界、时间投入、反馈方式和学生隐私没有说清，热情很快会变成沟通负担。

本章把 mentor relay 看成一种需要设计的课程机制。它要求把谁能提供什么帮助、何时介入、如何记录建议、哪些决定仍由课程团队负责写清楚，让外部支持真正变成学生学习资源。
